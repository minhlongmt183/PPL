...
class lexical_analysisLexer(Lexer):
    ...
    symbolicNames = [ "<INVALID>",
            "ID", "SEMI", "COLON", "VAR", "Identifier1", "Identifier2", 
            "REAL", "STR", "WS", "ERROR_CHAR", "UNCLOSE_STRING", "ILLEGAL_ESCAPE", 
            "UNTERMINATED_COMMENT" ]

    ruleNames = [ "ID", "SEMI", "COLON", "VAR", "Identifier1", "Identifier2", 
                  "LOWER_LETTER", "DIGIT", "REAL", "INT_PART", "DEC_PART", 
