...
class MPParser ( Parser ):
    ...
    class Many_declarationsContext(ParserRuleContext):
        ...
        def declaration(self):
            return self.getTypedRuleContext(MPParser.DeclarationContext,0)
    ...
    def many_declarations(self, _p:int=0):
        ...
        localctx = MPParser.Many_declarationsContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 2
        ...
        try:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    _prevctx = localctx
                    localctx = MPParser.Many_declarationsContext(self, _parentctx, _parentState)
    ...
    class DeclarationContext(ParserRuleContext):
        ...
        def variable_declaration(self):
            return self.getTypedRuleContext(MPParser.Variable_declarationContext,0)


        def function_declaration(self):
            return self.getTypedRuleContext(MPParser.Function_declarationContext,0)


        def procedure_declaration(self):
            return self.getTypedRuleContext(MPParser.Procedure_declarationContext,0)
    ...
    class Variable_declarationContext(ParserRuleContext):
        ...
        def list_declarations(self):
            return self.getTypedRuleContext(MPParser.List_declarationsContext,0)


        def getRuleIndex(self):
            return MPParser.RULE_variable_declaration
    ...
    def variable_declaration(self):
        ...
        localctx = MPParser.Variable_declarationContext(self, self._ctx, self.state)
    ...
    class List_declarationsContext(ParserRuleContext):
        ...
        def v_declaration(self):
            return self.getTypedRuleContext(MPParser.V_declarationContext,0)
        ...
        def getRuleIndex(self):
            return MPParser.RULE_list_declarations
    ...
    def list_declarations(self, _p:int=0):
        _parentctx = self._ctx
        _parentState = self.state
        localctx = MPParser.List_declarationsContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 8
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    if self._parseListeners is not None:
                        self.triggerExitRuleEvent()
                    _prevctx = localctx
                    localctx = MPParser.List_declarationsContext(self, _parentctx, _parentState)
    ...
    class V_declarationContext(ParserRuleContext):
        ...
        def list_identifiers(self):
            return self.getTypedRuleContext(MPParser.List_identifiersContext,0)
        ...
        def getRuleIndex(self):
            return MPParser.RULE_v_declaration
    ...
    def v_declaration(self):
        ...
        localctx = MPParser.V_declarationContext(self, self._ctx, self.state)
    ...
    class List_identifiersContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MPParser.RULE_list_identifiers
    ...
    def list_identifiers(self, _p:int=0):
        _parentctx = self._ctx
        _parentState = self.state
        localctx = MPParser.List_identifiersContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 12
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    if self._parseListeners is not None:
                        self.triggerExitRuleEvent()
                    _prevctx = localctx
                    localctx = MPParser.List_identifiersContext(self, _parentctx, _parentState)
    ...
    class Function_declarationContext(ParserRuleContext):
        ...
        def list_parameters(self):
            return self.getTypedRuleContext(MPParser.List_parametersContext,0)
    ...
    class List_parametersContext(ParserRuleContext):
        ...
        def not_null_list_parameters(self):
            return self.getTypedRuleContext(MPParser.Not_null_list_parametersContext,0)


        def getRuleIndex(self):
            return MPParser.RULE_list_parameters
    ...
    def list_parameters(self):
        ...
        localctx = MPParser.List_parametersContext(self, self._ctx, self.state)
    ...
    class Not_null_list_parametersContext(ParserRuleContext):
        ...
        def parameter_declaration(self):
            return self.getTypedRuleContext(MPParser.Parameter_declarationContext,0)
        ...
        def getRuleIndex(self):
            return MPParser.RULE_not_null_list_parameters
    ...
    def not_null_list_parameters(self, _p:int=0):
        _parentctx = self._ctx
        _parentState = self.state
        localctx = MPParser.Not_null_list_parametersContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 18
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    if self._parseListeners is not None:
                        self.triggerExitRuleEvent()
                    _prevctx = localctx
                    localctx = MPParser.Not_null_list_parametersContext(self, _parentctx, _parentState)
    ...
    class Parameter_declarationContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MPParser.RULE_parameter_declaration
    ...
    def parameter_declaration(self):
        ...
        localctx = MPParser.Parameter_declarationContext(self, self._ctx, self.state)
    ...
    def literal(self):
        ...
        try:
            ...
            self.state = 176
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << MPParser.INTEGER_LITERAL) | (1 << MPParser.REAL_LITERAL) | (1 << MPParser.TRUE) | (1 << MPParser.FALSE) | (1 << MPParser.STRING_LITERAL))) != 0)):
    ...
    class Array_typeContext(ParserRuleContext):
        ...
        def INTEGER_LITERAL(self, i:int=None):
            if i is None:
                return self.getTokens(MPParser.INTEGER_LITERAL)
            else:
                return self.getToken(MPParser.INTEGER_LITERAL, i)
    ...
    def expression_4(self):
        ...
        try:
            ...
            if token in [MPParser.SUB]:
                ...
                self.expression_4()
                pass
            elif token in [MPParser.LB, MPParser.INTEGER_LITERAL, MPParser.REAL_LITERAL, MPParser.TRUE, MPParser.FALSE, MPParser.STRING_LITERAL, MPParser.IDENTIFIER]:
                self.enterOuterAlt(localctx, 3)
                self.state = 293
                self.expression_5(0)
                pass
    ...
    def expression_6(self):
        ...
        try:
            ...
            if token in [MPParser.LB]:
                ...
                self.match(MPParser.RB)
                pass
            elif token in [MPParser.INTEGER_LITERAL, MPParser.REAL_LITERAL, MPParser.TRUE, MPParser.FALSE, MPParser.STRING_LITERAL, MPParser.IDENTIFIER]:
                self.enterOuterAlt(localctx, 2)
                self.state = 313
                self.operand()
                pass
    ...
    class Arr_elementContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MPParser.RULE_arr_element
    ...
    def arr_element(self):
        ...
        localctx = MPParser.Arr_elementContext(self, self._ctx, self.state)
    ...
    class Func_callContext(ParserRuleContext):
        ...
        def list_expression(self):
            return self.getTypedRuleContext(MPParser.List_expressionContext,0)
    ...
    class List_expressionContext(ParserRuleContext):
        ...
        def not_null_list_expression(self):
            return self.getTypedRuleContext(MPParser.Not_null_list_expressionContext,0)


        def getRuleIndex(self):
            return MPParser.RULE_list_expression
    ...
    def list_expression(self):
        ...
        localctx = MPParser.List_expressionContext(self, self._ctx, self.state)
        self.enterRule(localctx, 54, self.RULE_list_expression)
        try:
            self.state = 328
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [MPParser.NOT, MPParser.SUB, MPParser.LB, MPParser.INTEGER_LITERAL, MPParser.REAL_LITERAL, MPParser.TRUE, MPParser.FALSE, MPParser.STRING_LITERAL, MPParser.IDENTIFIER]:
                self.enterOuterAlt(localctx, 1)
                self.state = 326
    ...
    class Not_null_list_expressionContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MPParser.RULE_not_null_list_expression
    ...
    def not_null_list_expression(self, _p:int=0):
        _parentctx = self._ctx
        _parentState = self.state
        localctx = MPParser.Not_null_list_expressionContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 56
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    if self._parseListeners is not None:
                        self.triggerExitRuleEvent()
                    _prevctx = localctx
                    localctx = MPParser.Not_null_list_expressionContext(self, _parentctx, _parentState)
    ...
    class Assignment_statementContext(ParserRuleContext):
        ...
        def arr_element(self):
            return self.getTypedRuleContext(MPParser.Arr_elementContext,0)
    ...
    class List_var_idx_assContext(ParserRuleContext):
        ...
        def list_var_idx_ass(self):
            return self.getTypedRuleContext(MPParser.List_var_idx_assContext,0)
        ...
        def getRuleIndex(self):
            return MPParser.RULE_list_var_idx_ass
    ...
    def list_var_idx_ass(self, _p:int=0):
        _parentctx = self._ctx
        _parentState = self.state
        localctx = MPParser.List_var_idx_assContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 62
        ...
        try:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = MPParser.List_var_idx_assContext(self, _parentctx, _parentState)
    ...
    def return_statement(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << MPParser.NOT) | (1 << MPParser.SUB) | (1 << MPParser.LB) | (1 << MPParser.INTEGER_LITERAL) | (1 << MPParser.REAL_LITERAL) | (1 << MPParser.TRUE) | (1 << MPParser.FALSE) | (1 << MPParser.STRING_LITERAL) | (1 << MPParser.IDENTIFIER))) != 0):
                self.state = 414
                self.expression(0)
    ...
    class Compound_statementContext(ParserRuleContext):
        ...
        def list_statements(self):
            return self.getTypedRuleContext(MPParser.List_statementsContext,0)
    ...
    class List_statementsContext(ParserRuleContext):
        ...
        def not_null_list_statements(self):
            return self.getTypedRuleContext(MPParser.Not_null_list_statementsContext,0)


        def getRuleIndex(self):
            return MPParser.RULE_list_statements
    ...
    def list_statements(self):
        ...
        localctx = MPParser.List_statementsContext(self, self._ctx, self.state)
        self.enterRule(localctx, 78, self.RULE_list_statements)
        try:
            self.state = 425
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [MPParser.BREAK, MPParser.CONTINUE, MPParser.FOR, MPParser.WHILE, MPParser.WITH, MPParser.IF, MPParser.BEGIN, MPParser.RETURN, MPParser.LB, MPParser.INTEGER_LITERAL, MPParser.REAL_LITERAL, MPParser.TRUE, MPParser.FALSE, MPParser.STRING_LITERAL, MPParser.IDENTIFIER]:
                self.enterOuterAlt(localctx, 1)
                self.state = 423
    ...
    class Not_null_list_statementsContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MPParser.RULE_not_null_list_statements
    ...
    def not_null_list_statements(self, _p:int=0):
        _parentctx = self._ctx
        _parentState = self.state
        localctx = MPParser.Not_null_list_statementsContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 80
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    if self._parseListeners is not None:
                        self.triggerExitRuleEvent()
                    _prevctx = localctx
                    localctx = MPParser.Not_null_list_statementsContext(self, _parentctx, _parentState)
